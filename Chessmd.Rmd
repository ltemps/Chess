...
*density of number of moves, high density closer to zero
...
```{r echo= FALSE, fig.cap= "Distribution plots for opening move, termination type, time control, and number of moves"}
...
```{r, echo=FALSE, fig.height=4, fig.width= 10,fig.cap="Figure X"}
ggplot(Chess, aes(x= WhiteElo, y= Number_of_Moves)) +
...
If you cant figure out how to interpret this delete it
