...
summary(fit)
```
I fit a multilevel model to answer the question: Can you predict total number of moves in a chess match based on opening move and white player Elo? I used total number of moves as my response variable, with opening move as a fixed effect and white player Elo as a random effect. The fixed and random effect results are shown in the tables below. 
...
Given the model coefficients we can calculate the average number of moves in a match based on opening move and white player Elo.
...
Compare the difference between opening moves
