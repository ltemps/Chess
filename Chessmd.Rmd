...
```
Figure 2 shows that the relationship between white Elo rating and total number of moves has a varying slope and intercept when grouped by opening move. I have omitted points that would serve to represent each match due to the fact that there are almost 1 million matches in this data set.  
